          ...
          <Grid.Column tablet={5} computer={5} mobile={16}>
            <Card fluid raised>
              ...
              <Card.Content style={{ background: 'white' }}>
                <Card.Description>
                  <a style={{ color: 'grey' }} href={`https://www.google.com/maps/search/?api=1&query=${post.address}`}>
                    {post.address}
                  </a>
                </Card.Description>
                <Card.Description>
                  {`${formatPhoneNumber(post.phone)} |`}{' '}
                  <a style={{ color: '#1c70b5', fontWeight: 'bold' }} href={post.website}>
                    Website
                  </a>
                </Card.Description>
              </Card.Content>
