...
const TermsModal = () => (
    <Modal closeIcon trigger={<p style={{ color: 'blue', textDecoration: "underline", display: "inline-block", cursor: "pointer" }}>Terms and Conditions</p>}>
        <Modal.Header>Terms and Conditions</Modal.Header>
        <Modal.Content scrolling>
            <Modal.Description>
                <Header>TERMS OF USE</Header>
                <p>
                    The following terms and conditions (the "Agreement") form a binding agreement between you and Georgia on my Dime LLC, also referred to as “Georgia on my Dime,” “we,” “us” or “our.” By using the Site or any Georgia on my Dime services, you are agreeing to these terms, and all of these terms will govern your use of the Site and our Services. The term "you" refers to the person accessing or using the Site or our Services, or the company or organization on whose behalf that person accesses the Site or our Services.
IF YOU DO NOT AGREE TO THESE TERMS OF USE, IMMEDIATELY STOP USING THE SITE AND DO NOT USE ANY GEORGIA ON MY DIME SERVICE, PARTICIPATE IN ANY PROGRAM OR PURCHASE ANY VOUCHER OFFERED THROUGH THE SITE.
PLEASE REVIEW THE FOLLOWING SECTIONS OF THESE TERMS OF USE CAREFULLY.
        </p>
                <Header>ABOUT THE SITE</Header>
                <p>The Site is a platform through which certain merchants (“ Merchants ”) (a) sell vouchers for goods,
                    services, or experiences (“ Vouchers ”), and (b) sell dining experiences for specific dates and times.
                    Merchants are the sellers and issuers of the Merchant Offerings and are solely responsible to you for the care, quality, and
                    delivery of the goods and services provided. Vouchers may be distributed by Georgia on my Dime. </p>
                ...
                <ul>
                    ...
                    <li>You will only purchase a Merchant Offering through the Site by creating an account and any purchase will be subject to the applicable Terms of Sale set forth in these Terms of Use.</li>
                </ul>
                <Header>TERMS OF SALE</Header>
                <p>1.	VOUCHERS</p>
                <p>By placing an order for a Voucher, you are agreeing to the terms, restrictions and conditions associated with the Voucher.
                    You must have created an account on the Website to be eligible to purchase a Voucher.
                    Once you’ve placed your order, you will receive a receipt of the deal via email and a copy of the voucher will be available in your Georgia on my Dime account.
                    Your credit card will be charged for the amount of the Voucher at time of purchase. </p>
                ...
                <p>3.	VOUCHER TERMS</p>
                <p>Each Voucher is accompanied by a set of specific terms.
                    These terms are outlined to you at the time of purchase, and supersede the terms of this agreement,
                    except if in violation of applicable law. </p>
                <p>4.	TERMS OF SALE</p>
                <p>Unless otherwise stated in the Voucher or required by law, the following additional terms apply to all Vouchers:</p>
                <ul>
