...
const MobileHappyHourFinder = ({ happyhours, day, hood, changeHood }) => {
        ...
        <>
            ...
            <Grid style={{ margin: "0px" }}>
                <Grid.Column width={16}>
                    ...
                    <HHFinderCardGroup happyHours={happyhours} hood={hood} changeHood={changeHood} day={day} rows={1}></HHFinderCardGroup>
